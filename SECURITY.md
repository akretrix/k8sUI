...
- **Threat Model (STRIDE)**: [`THREAT_MODEL.md`](docs/security/THREAT_MODEL.md)
- **Security Anti-Patterns & Prohibitions ("What to Avoid")**: [`anti-patterns-and-prohibitions.md`](docs/security/anti-patterns-and-prohibitions.md)
- **AI Safety & Redaction Policy**: [`ai-safety.md`](docs/security/ai-safety.md)
- **Dependency & Licensing Policy**: [`dependency-policy.md`](docs/security/dependency-policy.md)
- **Security Scanning Matrix**: [`security-scanning-matrix.md`](docs/security/security-scanning-matrix.md)
